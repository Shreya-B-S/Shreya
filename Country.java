class Country{
static String[] countryName={"India","Sri Lanka","England","South Africa","USA","Pakistan","China"};
static int[] noOfStates={29,11,34,45,23,9,12};
static String[] listOfCapitals={"New Delhi","Colombo","London","Dont NO","Washington","Lahore","Shangai"};
